    ...
    return (
      <div className="border border-line p-8">
        ...
        <p className="mt-2 text-[13.5px] leading-relaxed text-muted">
          ...
          대표번호(<span className="tabular-nums">1688-3362</span>)로 문의하시거나,
          팩스(<span className="tabular-nums">031-794-5009</span>)로 보내주세요.
        </p>
    ...
    <form onSubmit={onSubmit} className="max-w-2xl space-y-6">
      ...
      <div>
        ...
        <p id="message-help" className="mt-2 text-[12.5px] text-muted">
          ※ 의뢰하는 품목 / 유형 / 제조공정 / 포장방법 / 출고 등 제품 스펙을
          자세히 설명 부탁드립니다.
        </p>
      </div>
        ...
        <label className="flex items-start gap-2.5 text-[13.5px]">
          ...
          <span>
            ...
            <span className="text-muted">
              견적 상담을 위해 사업자명·담당자·연락처·이메일을 수집하며, 상담
              완료 후 3년간 보관 후 파기합니다. 동의를 거부할 수 있으나 이 경우
              견적 상담이 제한됩니다.
            </span>
          </span>
        </label>
